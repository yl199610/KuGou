...
<body>
	<form name="serModifyForm" id="serModifyForm" style="margin-left: 50px; margin-top: 40px;">
		...
		<input name="kuSongStylenext" id="kuSongStylenext" value="0" readonly="readonly" required="required" placeholder="预留1" /><br />
		<input name="kuSongStylesecond" id="kuSongStylesecond"  value="0" required="required" placeholder="预留2" /><br />
